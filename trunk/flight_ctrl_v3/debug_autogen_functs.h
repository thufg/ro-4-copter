...
void debug_report_vars(Calibration * x)
{
	...
	fprintf_P(&serstream, PSTR("9, int32_t (%d), roll_accel_bot: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_accel_bot);
	fprintf_P(&serstream, PSTR("10, int32_t (%d), roll_accel_center: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_accel_center);
	fprintf_P(&serstream, PSTR("11, int32_t (%d), roll_accel_top: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_accel_top);
	fprintf_P(&serstream, PSTR("12, int32_t (%d), pitch_accel_bot: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_accel_bot);
	fprintf_P(&serstream, PSTR("13, int32_t (%d), pitch_accel_center: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_accel_center);
	fprintf_P(&serstream, PSTR("14, int32_t (%d), pitch_accel_top: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_accel_top);
	fprintf_P(&serstream, PSTR("15, int32_t (%d), vert_accel_bot: %d\r\n"), (uint8_t)sizeof(int32_t), x->vert_accel_bot);
	fprintf_P(&serstream, PSTR("16, int32_t (%d), vert_accel_top: %d\r\n"), (uint8_t)sizeof(int32_t), x->vert_accel_top);
	fprintf_P(&serstream, PSTR("17, int32_t (%d), roll_gyro_center: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_gyro_center);
	fprintf_P(&serstream, PSTR("18, int32_t (%d), pitch_gyro_center: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_gyro_center);
	fprintf_P(&serstream, PSTR("19, int32_t (%d), yaw_gyro_center: %d\r\n"), (uint8_t)sizeof(int32_t), x->yaw_gyro_center);
	fprintf_P(&serstream, PSTR("20, int32_t (%d), pitch_angle_offset: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_angle_offset);
	fprintf_P(&serstream, PSTR("21, int32_t (%d), roll_angle_offset: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_angle_offset);
	fprintf_P(&serstream, PSTR("22, int32_t (%d), pitch_gyro_to_rate: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_gyro_to_rate);
	fprintf_P(&serstream, PSTR("23, int32_t (%d), roll_gyro_to_rate: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_gyro_to_rate);
	fprintf_P(&serstream, PSTR("24, int32_t (%d), roll_ppm_center: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_ppm_center);
	fprintf_P(&serstream, PSTR("25, int32_t (%d), pitch_ppm_center: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_ppm_center);
	fprintf_P(&serstream, PSTR("26, int32_t (%d), yaw_ppm_center: %d\r\n"), (uint8_t)sizeof(int32_t), x->yaw_ppm_center);
	fprintf_P(&serstream, PSTR("27, int32_t (%d), throttle_ppm_center: %d\r\n"), (uint8_t)sizeof(int32_t), x->throttle_ppm_center);
	fprintf_P(&serstream, PSTR("28, int32_t (%d), roll_ppm_scale: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_ppm_scale);
	fprintf_P(&serstream, PSTR("29, int32_t (%d), pitch_ppm_scale: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_ppm_scale);
	fprintf_P(&serstream, PSTR("30, int32_t (%d), roll_gyro_scale: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_gyro_scale);
	fprintf_P(&serstream, PSTR("31, int32_t (%d), pitch_gyro_scale: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_gyro_scale);
	fprintf_P(&serstream, PSTR("32, int32_t (%d), yaw_gyro_scale: %d\r\n"), (uint8_t)sizeof(int32_t), x->yaw_gyro_scale);
	fprintf_P(&serstream, PSTR("33, int32_t (%d), throttle_ppm_scale: %d\r\n"), (uint8_t)sizeof(int32_t), x->throttle_ppm_scale);
	fprintf_P(&serstream, PSTR("34, int32_t (%d), throttle_hover: %d\r\n"), (uint8_t)sizeof(int32_t), x->throttle_hover);
	fprintf_P(&serstream, PSTR("35, int32_t (%d), roll_level_kp: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_level_kp);
	fprintf_P(&serstream, PSTR("36, int32_t (%d), roll_level_ki: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_level_ki);
	fprintf_P(&serstream, PSTR("37, int32_t (%d), roll_level_kd: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_level_kd);
	fprintf_P(&serstream, PSTR("38, int32_t (%d), pitch_level_kp: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_level_kp);
	fprintf_P(&serstream, PSTR("39, int32_t (%d), pitch_level_ki: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_level_ki);
	fprintf_P(&serstream, PSTR("40, int32_t (%d), pitch_level_kd: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_level_kd);
	fprintf_P(&serstream, PSTR("41, int32_t (%d), roll_rate_kp: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_rate_kp);
	fprintf_P(&serstream, PSTR("42, int32_t (%d), roll_rate_ki: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_rate_ki);
	fprintf_P(&serstream, PSTR("43, int32_t (%d), roll_rate_kd: %d\r\n"), (uint8_t)sizeof(int32_t), x->roll_rate_kd);
	fprintf_P(&serstream, PSTR("44, int32_t (%d), pitch_rate_kp: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_rate_kp);
	fprintf_P(&serstream, PSTR("45, int32_t (%d), pitch_rate_ki: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_rate_ki);
	fprintf_P(&serstream, PSTR("46, int32_t (%d), pitch_rate_kd: %d\r\n"), (uint8_t)sizeof(int32_t), x->pitch_rate_kd);
	fprintf_P(&serstream, PSTR("47, int32_t (%d), yaw_kp: %d\r\n"), (uint8_t)sizeof(int32_t), x->yaw_kp);
	fprintf_P(&serstream, PSTR("48, int32_t (%d), yaw_ki: %d\r\n"), (uint8_t)sizeof(int32_t), x->yaw_ki);
	fprintf_P(&serstream, PSTR("49, int32_t (%d), yaw_kd: %d\r\n"), (uint8_t)sizeof(int32_t), x->yaw_kd);
	fprintf_P(&serstream, PSTR("50, uint8_t (%d), yaw_ppm_chan: %d\r\n"), (uint8_t)sizeof(uint8_t), x->yaw_ppm_chan);
	fprintf_P(&serstream, PSTR("51, uint8_t (%d), throttle_ppm_chan: %d\r\n"), (uint8_t)sizeof(uint8_t), x->throttle_ppm_chan);
